    ...
    <div className="main border-b">
      <div className="navbar flex flex-wrap md:flex-nowrap h-auto md:h-32 items-center px-10">
        ...
        <div className="search w-full md:w-[60%] flex justify-center md:justify-start mb-4 md:mb-0">
          <div className="searchbar bg-[#f9fafb] w-[100%] md:w-[85%] h-12 rounded-md flex justify-between px-5 items-center">
        ...
        <div className="cart-filters w-full md:w-[35%] flex flex-wrap gap-3 items-center justify-center md:justify-end">
          ...
          {/* Cart */}
          <div className="cart bg-[#0093d0] flex px-4 py-3 rounded-lg gap-2 text-white font-medium">
          <Image
            src={cart}
            alt="Image"
            className="h-5"
      ...
      <div className="subnav list-none flex justify-around uppercase px-7 text-[#6b7280] flex-wrap">
